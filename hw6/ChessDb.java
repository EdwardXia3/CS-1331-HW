...
/**
 * Creates a database containing information of specific chessgames.
 *
 * @author exia3
 * @version 1.0
 */
public class ChessDb {
    ...
    /**
     * Instantiates a new arraylist and adds data of specific games to the list.
     *
     */
    public ChessDb() {
        games = new ArrayList<>();
    ...
    /**
     * Gettor method that retrieves the games array.
     *
     * @return games arraylist containing the data of specific games
     */
